...
class AdminController extends Controller
{
    ...
    public function admin_tournaments_for_delete()
    {
    ...
    public function tournament_requests(Request $request)
    {
    ...
    public function admin_delete_request(Request $request)
    {
    ...
    public function delete_tournament_player(Request $request)
    {
