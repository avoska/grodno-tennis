...
<div class="container-fluid shadow indent-10-percents">
    ...
    <div class="row text-center">
        <form method="post" action="{{ route('admin_add_post_tournament') }}">
            {{ csrf_field() }}

            <div class="col-lg-6 col-sm-9 col-md-10 col-xs-8 text-left">
                <label for="name" class="second-section-textstyle"><strong>Название турнира:<br></strong></label>
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    <input id="name" type="text" name="name" placeholder="Обязательное поле для ввода" value="" class="form-control input-box" required>
                    @if ($errors->has('name'))
                ...
                <label for="date_of_start" class="second-section-textstyle"><strong>Дата начала турнира:<br></strong></label>
                <div class="form-group{{ $errors->has('date_of_start') ? ' has-error' : '' }}">
                    <input id="date_of_start" type="text" name="date_of_start" placeholder="Обязательное поле для ввода" value="" class="form-control input-box" required maxlength="50">
                ...
                <label for="date_of_finish" class="second-section-textstyle"><strong>Дата окончания турнира:<br></strong></label>
                <div class="form-group{{ $errors->has('date_of_finish') ? ' has-error' : '' }}">
                    <input id="date_of_finish" type="text" name="date_of_finish" placeholder="Обязательное поле для ввода" class="form-control input-box" value="" required maxlength="50">
            ...
            <div class="col-lg-4 col-sm-9 col-md-10 col-xs-12 text-left">
                ...
                <div class="form-group{{ $errors->has('time') ? ' has-error' : '' }}">
                    <input id="time" type="text" name="time" placeholder="Обязательное поле для ввода" class="form-control input-box" value="" required maxlength="50">
                    @if ($errors->has('time'))
                        <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('playground_id') ? ' has-error' : '' }}">
                    <input id="playground_id" type="text" name="playground_id" placeholder="Обязательное поле для ввода" value="" class="form-control input-box" required maxlength="3">
                ...
                <label for="max_players" class="second-section-textstyle"><strong>Телефон<br></strong></label>
                <div class="form-group{{ $errors->has('max_players') ? ' has-error' : '' }}">
                    <input id="max_players" type="text" name="max_players" value="" class="form-control input-box" maxlength="50">
