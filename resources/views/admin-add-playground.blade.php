        ...
        <form method="post" action="{{ route('admin_add_post_tournament') }}">
            ...
            <div class="col-lg-6 col-sm-9 col-md-10 col-xs-8 text-left">
                ...
                <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                    <input id="address" type="text" name="address" placeholder="Обязательное поле для ввода" value="" class="form-control input-box" required>
                ...
                <div class="form-group{{ $errors->has('worktime') ? ' has-error' : '' }}">
                    <input id="worktime" type="text" name="worktime" placeholder="Обязательное поле для ввода" value="" class="form-control input-box" required maxlength="50">
                ...
                <div class="form-group{{ $errors->has('surface') ? ' has-error' : '' }}">
                    <input id="surface" type="text" name="surface" placeholder="Обязательное поле для ввода" class="form-control input-box" value="" required maxlength="50">
            ...
            <div class="col-lg-4 col-sm-9 col-md-10 col-xs-12 text-left">
                ...
                <div class="form-group{{ $errors->has('time') ? ' has-error' : '' }}">
                    <input id="type" type="text" name="type" placeholder="Обязательное поле для ввода" class="form-control input-box" value="" required maxlength="50">
                    @if ($errors->has('type'))
                        <span class="help-block">
